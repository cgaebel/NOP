...
static void RestoreMRSDecryptionRoutines()
{
	Patching::Patch((void*)0x00538680,
		...
		"\x14\x8A\x01\x90\x90\x2C" MRS_KEY "\x90\x90\x90\x90\x90\x90\x90\x90\x88"
	...
	Patching::Patch((void*)0x00538960,
		...
		"\x1E\x00\x00\x00\x8A\x01\x90\x90\x2C" MRS_KEY "\x90\x90\x90\x90\x90\x90"
	...
	Patching::Patch((void*)0x00538C20,
		...
		"\x8A\x01\x90\x90\x2C" MRS_KEY "\x90\x90\x90\x90\x90\x90\x90\x90\x88\x01"
